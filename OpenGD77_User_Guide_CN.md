...
- 在**联系人选择界面**，按压 **蓝色**  + **#**组合键，可以为电台输入一个*另一个* **DMR ID** 临时覆盖电台配置文件中的 DMR ID。（*用于测试目的*）
...
- 按压 **蓝色** + **#** 组合键可以在 DTMF 输入和 DTMF 联系人列表界面之间切换。
...
*提示 :* 对于发射与接收哑音，长按**左**或**右**方向键可以连续跳转。按住 **蓝色** 再按压**左**或**右**方向键可直接跳转到 CTCSS/DCS/DCSN 开头或末尾。
