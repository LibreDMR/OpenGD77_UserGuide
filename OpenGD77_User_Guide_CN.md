...
＃ **重要**提示：该固件不兼容 2022 新版宝峰 DM-1801，或新版 DM-1801A #
...
- 宝峰 DM-1801（仅限第 1 版硬件） （又名 宝峰 DM-860）

- 宝峰 DM-1801A（仅限第 1 版硬件）
...
_请注意 :_
- *该固件与宝峰 DM-1801 的新 2022 版本或 DM-1801A 不兼容，因为其使用了完全不同的内部硬件和电子设备。*
- 原厂提供的 CPS 软件与本固件不兼容，请使用 **OpenGD77 CPS**。它可以从本指南的[1.1 章节处](#下载链接与其他资源)下载。包括宝峰、特易通、Retevis 和其他支持的电台必须使用OpenGD77 CPS。
...
- 通过以下方式使电台进入固件更新模式：
  ...
  - 按住如下所示的两个按键（**S1**,**Fn**）并打开电台。
    ...
    - 宝峰 DM-1801（第 1 版）或 DM-1801A（第 1 版）或 DM-860：
